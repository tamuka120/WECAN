...
<div class='form-content form-div'>
	<?php echo form_open( "http://localhost:8080/football1/index.php/main/getvalue", 'method="post" id="crudhForm" autocomplete="off" enctype="multipart/form-data"'); ?>
		<div>
			<?php
			$counter = 0;
			...
			<div class='form-field-box <?php echo $even_odd?>' id="<?php echo $field->field_name; ?>_field_box">
				...
				<div class='form-input-box' id="<?php echo $field->field_name; ?>_input_box" required>
		...
		<div class='buttons-box'>
			...
			<div class='form-button-box'>
				...
				<input id="form-button-save" type='submit' value='<?php echo $this->l('form_save'); ?>' class='ui-input-button' disabled="disabled"/>
			</div>
