...
<div class='form-content form-div'>
	<?php echo form_open( "main/getvalue", 'method="post" id="crudForm" autocomplete="off" enctype="multipart/form-data onsubmit="return validateForm()"'); ?>
		<div>
			<?php
			$counter = 0;
		...
		<div class='buttons-box'>
			...
			<div class='form-button-box'>
				<input name="submit" id="submit" type='submit' value='<?php echo $this->l('form_save'); ?>' class='ui-input-button'/>
			</div>
